...
- Buť, nějaký lokální server jako je WampServer nebo docker s MySQL, PHP a Adminer (Pro linux)
...
2. **Docker (Linux)**
    ...
    - Daná aplikace se pak nachází na: http://localhost:8080/Source/index.php
